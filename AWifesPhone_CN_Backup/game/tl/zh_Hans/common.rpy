...
translate zh_Hans strings:
    ...
    new "无障碍菜单。使用上下方向键导航，按 Enter 激活按钮和滑条。"
    ...
    new "此菜单中的选项旨在改善无障碍体验。它们不一定适用于所有游戏，某些选项组合可能会导致游戏无法游玩。这不是游戏或引擎的问题。更改字体时，为获得最佳效果，请尽量保持文本大小与原本一致。"
    ...
    new "此存档创建于另一台设备。恶意构造的存档文件可能会损害你的电脑。你信任此存档的创建者以及所有可能修改过该文件的人吗？"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "你信任创建此存档的设备吗？只有在你是该设备唯一使用者时才应选择是。"
    ...
    new "本程序包含多种许可证下的自由软件，包括 MIT 许可证和 GNU 宽通用公共许可证。完整的软件列表以及完整源代码链接可在{a=https://www.renpy.org/l/license}此处{/a}找到。"
    ...
    new "这会将你的存档上传到 {a=https://sync.renpy.org}Ren'Py Sync 服务器{/a}。\\n要继续吗？"
    ...
    new "这将联系 {a=https://sync.renpy.org}Ren'Py Sync 服务器{/a}。"
